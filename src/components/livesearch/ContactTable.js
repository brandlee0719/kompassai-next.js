...
import LockIcon from '@/assets/image/livesearch/lock.svg';
import { ReactComponent as BookmarkSVG } from "@/assets/image/livesearch/bookmark.svg";

import TwitterIcon from "@/assets/image/livesearch/twitter.svg";
import FacebookIcon from "@/assets/image/livesearch/facebook.svg";
import LinkedinIcon from "@/assets/image/livesearch/linkedin.svg";
      ...
      >
        ...
        <TableCell padding="none" align="left">
          <div className="w-full flex flex-row justify-end items-center gap-1">
            ...
            <Button className="flex items-center justify-center text-black border-[1px] border-[#929292] text-sm font-Outfit rounded-full py-1">
            ...
            <div className="w-full flex flex-col bg-white rounded-xl p-5 gap-4">
              <div className="w-full flex flex-row justify-between">
                ...
                <div className="w-full flex flex-row justify-end items-center gap-1">
                  ...
                  <Button className="border-none bg-[#E7436A]  font-Outfit text-white font-extralight text-xs rounded-full px-4 py-2 ml-4">
                    Access email
                  </Button>
                  <Button className="border-none bg-[#E7436A]  font-Outfit text-white font-extralight text-xs rounded-full px-4 py-2">
                    Access Phone
                  </Button>
                </div>
              </div>
              ...
              <div className="w-full grid grid-cols-6 gap-1">
                <div className="col-span-1 flex flex-col gap-2">
                  ...
                  <div className="text-[#E7436A] text-sm">PineDev Studio</div>
                </div>
                <div className="col-span-1 flex flex-col gap-2">
  ...
  return (
    <Box sx={{ width: "100%", mt: "10px" }}>
      ...
      <div className="w-full flex justify-end">
        <Pagination className='font-Outfit' count={Math.floor(rows.length / rowsPerPage)} page={page} onChange={handleChangePage} showFirstButton showLastButton sx={{
