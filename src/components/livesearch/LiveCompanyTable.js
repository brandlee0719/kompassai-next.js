      ...
      >
        ...
        <TableCell component="th" id={labelId} scope="row" padding="none">
          <div className="w-full flex flex-row items-center gap-3">
            ...
            <div className="flex flex-col justify-start text-sm">
              <p>{row.company}</p>
              <p className="text-magenta-500">{row.companyInfo}</p>
        ...
        <TableCell padding="none" align="left">
          <div className="w-full flex flex-row justify-end items-center gap-1">
            ...
            <Button className="flex items-center justify-center text-black border-[1px] border-[#929292] text-xs font-Outfit rounded-full px-3 py-2">
              Employees
            </Button>
