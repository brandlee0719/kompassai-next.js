    ...
    <div className="mx-[16px] mt-[20px] flex h-[743px] w-[315px] flex-col justify-between rounded-[30px] border-[1px] p-[8px_8px] md:h-[843px] xl:w-[280px] 2xl:w-[315px]">
      <div>
        <div className="flex w-full flex-col  items-center rounded-[24px] bg-[#F3F3F3] p-[24px_24px]">
          <div className="font-Outfit text-3xl font-[700] text-stone-950">
            Free
          </div>
          <div className="font-Outfit text-sm font-[400] text-stone-950 opacity-60">
            Test drive it
          </div>
          <div className="mt-[15px] flex flex-row">
            <div className="font-Outfit text-5xl font-[600] text-stone-950 ">
              $0
            </div>
            <div className="flex items-end">
              <div className="  font-Outfit text-xl font-[700] text-stone-950 ">
                /mo
              </div>
            </div>
          </div>
