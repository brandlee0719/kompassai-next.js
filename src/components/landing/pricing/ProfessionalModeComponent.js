    ...
    <div className="mx-[16px] mt-[20px] flex h-[743px] w-[315px] flex-col justify-between rounded-[30px] border-[1px] p-[8px_8px] md:h-[843px] xl:w-[280px] 2xl:w-[315px]">
      <div>
        <div className="flex h-[158px] w-full  flex-col items-center rounded-[24px] bg-[#F0FEFC] p-[24px_24px] md:h-[178px]">
          <div className="font-Outfit text-3xl  font-[700] text-[#75EED9]">
            Professional
          </div>
          ...
          <div className="mt-[15px] flex flex-row">
            <div className="font-Outfit text-5xl font-[600] text-[#75EED9] ">
              $29
            </div>
            <div className="flex items-end">
              <div className="  text-md font-Outfit font-[700] text-[#75EED9] ">
                /user/month
              </div>
            </div>
          </div>
