...
export default function CustomSlider() {
  const Thumb1 = (props, state) => (
    <div
      {...props}
      className="flex p-[4px] md:p-[4px] flex-row justify-between items-center top-0  w-[50px] md:w-[100px] h-[25px] md:h-[25px] bg-[#75EED9] rounded-full mb-[20px]"
    >
      <div>
        <img src={LeftIcon} />
      </div>
      <div className="font-Outfit text-[12px] md:text-[13px] text-emerald-500 font-[700]">
        ${state.valueNow}
      </div>
      <div>
        <img src={RightIcon} />
