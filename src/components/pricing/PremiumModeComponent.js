  ...
  return (
    <div className="mx-[16px] mt-[20px] flex h-[743px] w-[315px] flex-col justify-between rounded-[30px] border-[1px] p-[8px_8px] md:h-[843px] xl:w-[280px] 2xl:w-[315px]">
      <div className=" relative">
        <div className="flex  w-full flex-col   items-center rounded-[24px] bg-[#FFEEF2] p-[24px_24px]">
          <Text
            variant="Caption"
            className="absolute  -top-[25px]  left-[110px] flex rotate-6 items-center justify-center  rounded-[8px] bg-magenta-500 p-[12px] text-white  drop-shadow-lg"
          >
            Most popular
          </Text>
          <Text variant="Header4" className="text-magenta-500">
            Premium
          </Text>
          <Text
          ...
          <div className="mt-[15px] flex flex-row">
            <Text variant="Header3" className="text-magenta-500">
              $51
            </Text>
            <div className="flex items-end">
              <Text variant="CaptionBig" className="text-magenta-500">
                /user/month
              </Text>
            </div>
          </div>
