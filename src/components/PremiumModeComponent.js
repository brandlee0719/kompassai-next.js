...
export default function PremiumModeComponent(props) {
  ...
  return (
    <div className="mx-[16px] mt-[20px] flex h-[743px]   w-[366px] flex-col justify-between rounded-[30px] border-[1px] border-[#E7436A] p-[8px_8px] md:h-[843px]">
      <div className=" relative">
        <div className="flex  h-[158px] w-full  flex-col items-center  rounded-[24px] bg-[#FFEEF2] p-[24px_24px] md:h-[178px]">
          <div className="absolute  -top-[25px]  left-[110px] flex rotate-6 items-center justify-center rounded-[8px]  bg-magenta-500 p-[12px] text-[14px]  font-[700] text-white">
            Most popular
          </div>
          <div className="font-Outfit text-[25px] font-[700] text-magenta-500 md:text-[28px]">
            Premium
          </div>
          ...
          <div className="flex flex-row ">
            <div className="font-Outfit text-[40px] font-[600] text-magenta-500 md:text-[46px] ">
              $51
            </div>
            <div className="flex items-end  py-[10px]">
              <div className="  font-Outfit text-[16px] font-[700] text-magenta-500 ">
                /user/month
              </div>
            </div>
          </div>
        ...
        <div className="p-[32px_24px]">
          ...
          <Button className="font-Outfit mt-[30px] flex h-[52px] w-full items-center justify-center rounded-full bg-magenta-500 px-[24px]  text-[16px] font-[700] text-white">
            GET STARTED
          </Button>
