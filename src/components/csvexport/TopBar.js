...
export default function TopBar(props) {
  return (
    <div className="w-full bg-[#4DBBA8]">
      <BaseContainer width={pageContentWidth}>
        <div className="w-full flex flex-col md:flex-row md:justify-between py-[60px] px-[24px] md:pl-[80px] md:pr-[0px] ">
          <div className="relative flex flex-col items-center md:items-start">
            <Button className="rounded-full p-[5px_16px] text-xs md:text-lg font-[400] text-[#0A2E31] font-Outfit bg-[#94EADC]">
              CSV export
            </Button>
            <div className="font-Outfit w-full md:w-[450px] xl:w-[870px] leading-none text-5xl 2xl:text-7xl font-[700] text-[#090C05] mt-[24px] break-words">
