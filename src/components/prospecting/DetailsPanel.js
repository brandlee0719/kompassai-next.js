...
export default function DetailPanel(props) {
  return (
    <div className="bg-emerald-200 p-[24px] sm:p-[48px] md::p-[80px] ">
      <BaseContainer width={pageContentWidth}>
        <div className="flex flex-col lg:flex-row">
          <div className="flex-1 flex-col items-start">
            ...
            <Text className="text-stone-950 mt-[60px]">
              You usually need to open a local entity to hire an employee in
              another
              ...
              <div className="flex flex-row items-center">
                ...
                <div className="mx-[12px] md:mx-[48px]">
                  ...
                  <div className="font-Outfit text-lg font-[400] text-stone-950 mt-[10px]">
                    With legal entities in 100+ countries and expert visa
                    support, onboard worldwide employees from anywhere.
                  </div>
                </div>
              </div>
              <hr
            ...
            <div>
              <div className="flex flex-row items-center ">
                ...
                <div className="mx-[12px] md:mx-[48px]">
                  ...
                  <div className="font-Outfit text-lg font-[400] text-stone-950 mt-[10px]">
                    Pay everyone with one bulk payment and we will manage the
                    hard stuff like tax deductions, pensions, benefits, and
                    government fees.
                  </div>
                </div>
              </div>
